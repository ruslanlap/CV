...
/**
 * Client-side PDF page content with error boundary
 */
export default function PDFPageContent({ cv, lang }: PDFPageContentProps) {
    return (
        <PDFErrorBoundary lang={lang}>
            <main className="mx-auto max-w-4xl bg-white p-10 text-black print:p-0">
                ...
                <section className="mt-6">
                    <h2 className="text-xl font-semibold">
                        {lang === "ua" ? "Професійний профіль" : "Professional Summary"}
                    </h2>
